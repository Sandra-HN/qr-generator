...
const CustomQRCodeGenerator = () => {
  const [text, setText] = useState("https://khaledaltheeb.com");
      ...
      <div className="flex gap-y-4 lg:flex-row flex-col-reverse justify-between w-full px-4">
        ...
        >
          ...
          <div className="w-full">
            ...
            className="w-full bg-transparent border outline-none text-white p-2"
            value={qrCodeDotStyle}
            onChange={(e) => {
              setQrCodeDotStyle(e.target.value);
            }}
          /> */}
            </div>
          </div>
                ...
                <label htmlFor="c1">
                  <div class="flex w-full items-center active:ring-2 ring-black rounded">
                    <input
                      ...
                      onClick={(e) => {
                        if (e.target.checked) {
                          setQrEyeInnerColor(null);
                          setQrEyeOuterColor(null);
                        }
        ...
        {text && (
          <div className=" w-full lg:w-3/12 flex flex-col items-center bg-white p-4 rounded-lg">
            <div ref={qrCodeRef1} className="mb-4">
              <QRCode
                ...
                eyeColor={
                  qrEyeInnerColor || qrEyeOuterColor
                    ? [
